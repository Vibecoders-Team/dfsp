  ...
  const loginWithTon = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        await miniUpdateRsaPublic(publicPem);
        console.info('[MiniAuth] RSA public key published for TON user');
      } catch (rsaError) {
        console.warn('[MiniAuth] Failed to publish RSA public key:', rsaError);
