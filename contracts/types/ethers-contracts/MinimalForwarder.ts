...
export declare namespace MinimalForwarder {
    ...
    export type ForwardRequestStruct = {from: AddressLike, to: AddressLike, value: BigNumberish, gas: BigNumberish, nonce: BigNumberish, data: BytesLike}

    export type ForwardRequestStructOutput = [from: string, to: string, value: bigint, gas: bigint, nonce: bigint, data: string] & {from: string, to: string, value: bigint, gas: bigint, nonce: bigint, data: string }
